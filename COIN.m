classdef COIN < matlab.mixin.Copyable
    ...
    methods
        ...
        function x = sample_from_truncated_bivariate_normal(obj,mu,V)
            ...
            x = mu + obj.per_slice_multiply(V_cholesky,reshape(obj.trandn(l,u),[2,size(V,3)]));
    ...
    methods (Access = private)
        ...
        function x = trandn(obj,l,u)
            ...
            if any(I)
                tl = l(I);
                tu = u(I);
                x(I) = obj.trandn_central(tl,tu);
            end
        end

        function x = trandn_tail(~,l,u)
            c = l.^2 / 2;
            n = length(l);
            f = expm1(c - u.^2 / 2);
        ...
        function x = trandn_central(obj,l,u)
            tol = 2;
            I = abs(u - l) > tol;
            x = l;
            if any(I)
